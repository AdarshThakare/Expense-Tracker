...
const Navbar = ({ activeMenu }: CommonProps) => {
  ...
  return (
    <div className="w-full flex gap-5 bg-white fixed border border-b border-gray-200/50 backdrop-blur-[2px] py-2 md:py-4 px-4 md:px-6  top-0 z-30 shadow shadow-fuchsia-200">
      <button
      ...
      <div className="w-full flex items-center justify-between">
        <h2 className="text-lg md:text-2xl font-mono font-bold text-black">
          <span className="text-purple-500">EXPENSE</span>💰TRACKER
        </h2>
        <div className="me-8 hidden md:block">
